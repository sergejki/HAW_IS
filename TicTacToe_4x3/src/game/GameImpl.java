...
public class GameImpl extends Thread {
    ...
    private boolean isOver() {
        ...
        try {
            result = result ? result : (getValue(1, 1) == getValue(1, 2) && getValue(1, 2) == getValue(1, 3));
        } catch (FieldNotMarkedException e) {
        }
        try {
            result = result ? result : (getValue(1, 2) == getValue(1, 3) && getValue(1, 3) == getValue(1, 4));
        } catch (FieldNotMarkedException e) {
        }
        try {
            result = result ? result : (getValue(2, 1) == getValue(2, 2) && getValue(2, 2) == getValue(2, 3));
        } catch (FieldNotMarkedException e) {
        }
        try {
            result = result ? result : (getValue(2, 2) == getValue(2, 3) && getValue(2, 3) == getValue(2, 4));
        } catch (FieldNotMarkedException e) {
        }
        try {
            result = result ? result : (getValue(3, 1) == getValue(3, 2) && getValue(3, 2) == getValue(3, 3));
        } catch (FieldNotMarkedException e) {
        }
        try {
            result = result ? result : (getValue(3, 2) == getValue(3, 3) && getValue(3, 3) == getValue(3, 4));
        } catch (FieldNotMarkedException e) {
        }
        ...
        if (!result) {
            try {
                result = result ? result : (getValue(1, 1) == getValue(2, 1) && getValue(2, 1) == getValue(3, 1));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(1, 2) == getValue(2, 2) && getValue(2, 2) == getValue(3, 2));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(1, 3) == getValue(2, 3) && getValue(2, 3) == getValue(3, 3));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(1, 4) == getValue(2, 4) && getValue(2, 4) == getValue(3, 4));
            } catch (FieldNotMarkedException e) {
            }
        }
        ...
        if (!result) {
            try {
                result = result ? result : (getValue(1, 1) == getValue(2, 2) && getValue(2, 2) == getValue(3, 3));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(1, 2) == getValue(2, 3) && getValue(2, 3) == getValue(3, 4));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(3, 1) == getValue(2, 2) && getValue(2, 2) == getValue(1, 3));
            } catch (FieldNotMarkedException e) {
            }
            try {
                result = result ? result : (getValue(3, 2) == getValue(2, 3) && getValue(2, 3) == getValue(1, 4));
            } catch (FieldNotMarkedException e) {
            }
        }
